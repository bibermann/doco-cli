...
def down_project(compose_dir: str, compose_file: str, options: Options, info: ProjectInfo):
...
def main(args) -> int:
    for compose_dir, compose_file in find_compose_projects(args.projects):
        do_project_cmd(
            ...
            cmd_task=lambda info: down_project(compose_dir, compose_file, options=Options(
